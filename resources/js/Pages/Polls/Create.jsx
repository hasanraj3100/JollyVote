...
function CreatePoll() {
    ...
    return (
        ...
        <AuthenticatedLayout>
            ...
            <div className="bg-gray-50 min-h-screen flex mt-10 justify-center">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            ...
                            <button
                                type="button"
                                onClick={addOption}
                                className="mt-2 inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500"
                            >
                                Add Option
                            </button>
                        ...
                        <button
                            type="submit"
                            className="w-full inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-sky-600 hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        >
                            Create Poll
                        </button>
